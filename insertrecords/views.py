...
def insertRecords(request):
    if request.method == 'POST':
        ...
        records = HealthRecords(Gender=gender,Age=age,Hypertension=hypertension,Heartdisease=heartdisease,Evermarried=evermarried,Worktype=worktype,Residencetype=residencetype, Glucoselevel=glucoselevel,Bmi=bmi,Smokingstate=smokingstatus,Strokestatus=strokestatus)
        records.save()
